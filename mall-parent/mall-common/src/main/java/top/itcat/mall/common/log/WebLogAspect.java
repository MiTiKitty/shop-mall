...
import top.itcat.mall.common.domain.DescOperation;
import top.itcat.mall.common.domain.WebLog;
...
public class WebLogAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (method.isAnnotationPresent(DescOperation.class)) {
            DescOperation log = method.getAnnotation(DescOperation.class);
